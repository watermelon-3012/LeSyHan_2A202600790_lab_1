...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_cost = (len(gpt4o_response.split()) / 0.75) / 1000 * COST_PER_1K_OUTPUT_TOKENS["gpt-4o"]
    mini_cost = (len(mini_response.split()) / 0.75) / 1000 * COST_PER_1K_OUTPUT_TOKENS["gpt-4o-mini"]
...
def streaming_chatbot() -> None:
    ...
    while True:
        ...
        # Update history with the assistant's reply and trim to last 3 turns
